...
当前 M1 环境与仓库只读阶段已完成，macOS Apple Silicon 本机已验证真实 Git 状态和差异；2026-09-22 补充 Windows 本机测试与构建验证，原生交互及剩余兼容性边界见验证记录。M2、M3 已按本轮要求合并规划，并纳入 HTML 工作台改版；独立方案待评审，功能尚未实施。

## 阅读顺序

1. [需求与实施计划](spec-plan.md)：产品总览、阶段和历史验收基线；第 9 节保留旧 M2 草案。本轮执行基线为 [M2 + M3 合并开发 spec/plan](m2-m3-spec-plan.md)，包含本地操作、远端协作、冲突处理和 HTML 工作台改版，待评审、尚未实施。
